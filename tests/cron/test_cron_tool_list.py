...
def test_add_at_job_uses_default_timezone_for_naive_datetime(tmp_path) -> None:
    ...
    result = tool._add_job(None, "Morning reminder", None, None, None, None, "2026-03-25T08:00:00")
...
def test_add_job_can_disable_delivery(tmp_path) -> None:
    ...
    result = tool._add_job(None, "Background refresh", None, 60, None, None, None, deliver=False)
